                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="his_admin_logout.php">
                                        <span><img src="assets/images/logo-logo.png" alt="" height="22"></span>
                                    </a>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted font-13"> Vous vous êtes déconnecté avec succès. </p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50"><a href="index.php" class="text-white ml-1"><b>Se connecter</b></a> OU retourner à l' <a href="../../index.php" class="text-white ml-1"><b>Accueil</b></a></p>
                            </div> 
                        </div>
